...
function Header({ onPlayClick }) {
  ...
  return (
    <header className="bg-background border-b-4 border-shade sticky top-0 z-40">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <button
          onClick={onPlayClick}
          className="border-4 border-shade rounded-full font-bold px-6 py-2 bg-sunlit shadow-[4px_4px_0px_0px_var(--shade)] hover:bg-sunlit-deep transition-colors cursor-pointer text-shade"
        >
          Oyuna Başla →
        </button>
      </div>
