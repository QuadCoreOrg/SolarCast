...
function PowerCenterScreen() {
  ...
  const unlockPanelSlot = useGameStore((s) => s.unlockPanelSlot)
  ...
  const handlePanelPurchase = () => {
    ...
    if (activePanels.length >= unlockedPanelSlots) {
      setPurchaseError('Önce güç merkezinde panel yuvası aç.')
      return
    }
        ...
        <section className="max-w-6xl mx-auto space-y-4">
          <article className="rounded-2xl border-4 border-slate-900 bg-background p-4 shadow-[4px_4px_0px_0px_var(--shade)]">
            ...
            <PowerHub
              ...
              unlockedPanelSlots={unlockedPanelSlots}
